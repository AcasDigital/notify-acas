...
#[\Attribute]
class VerificationEmailRequirements extends Compound
{
    /**
    ...
    {
        return [
            new Assert\NotBlank(message: 'Enter the confirmation code you received by email. The code is 5 numbers only.'),
