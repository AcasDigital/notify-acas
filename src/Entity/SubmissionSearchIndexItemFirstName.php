...
#[ORM\Entity(repositoryClass: SubmissionSearchIndexItemFirstNameRepository::class)]
#[ORM\Index(name: 'firstname_search_idx', columns: ['keyword', 'section'])]
class SubmissionSearchIndexItemFirstName
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: EmploymentDispute::class, inversedBy: 'searchIndexItemsFirstName')]
