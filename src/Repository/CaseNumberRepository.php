...
/**
 * @extends ServiceEntityRepository<CaseNumber>
 */
class CaseNumberRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(CaseNumber $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(CaseNumber $entity, bool $flush = true): void
    {
